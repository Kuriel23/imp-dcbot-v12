...
module.exports = {
  name: "blackjack",
  description: "Jogue Blackjack, quem será que ganha?",
  aliases: ["21"]
};
...
module.exports.run = async (client, message, res) => {
  ...
  function endMsg(title, msg, dealerC) {
    ...
    const gambleEmbed = new Discord.MessageEmbed()
      .setColor(client.cor)
      .setTitle(`Mesa de Jogo do ` + message.author.username)
      ...
      .catch(_ => {
        message.inlineReply(
          new Discord.MessageEmbed()
            .setAuthor("» Você perdeu todo o dinheiro apostado.", client.warn)
            .setColor(client.cor)
        );
        return;
      });
